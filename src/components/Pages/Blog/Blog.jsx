        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-5 col-md-5 col-12 mb-4">
              <div
                className="blog-sidebar d-flex justify-content-center align-items-center"
                data-aos="fade-up"
                data-aos-delay={200}
              >
                <img
              ...
              <div
                className="blog-sidebar py-4 d-flex justify-content-center align-items-center"
                data-aos="fade-up"
                data-aos-delay={300}
              >
                <img
              ...
              >
                ...
                <div className="blog-info">
                  ...
                  <h3>
                    <a href="blog-detail.html">
                      The Mistakes I Made As a Coding Beginner
                    </a>
                  </h3>
                </div>
              </div>
